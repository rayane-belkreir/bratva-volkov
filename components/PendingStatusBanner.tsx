...
import { ApplicationStatusPopup } from "@/components/ApplicationStatusPopup";
      ...
      >
        <div className="container mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="px-3 py-1 bg-patina-gold/20 border border-patina-gold/40 text-patina-gold hover:bg-patina-gold/30 transition-colors text-xs font-bold uppercase rounded"
          >
            Voir le statut
          </button>
        </div>
      </motion.div>
      <ApplicationStatusPopup isOpen={showPopup} onClose={() => setShowPopup(false)} />
    </>
  );
}
